...
class Article(models.Model):
    ...
    article_from = models.IntegerField(default=0,choices=ARTICLE_FROM,verbose_name=u'文章来源',null=True)
    ...
    status = models.IntegerField(default=0,choices=STATUS,verbose_name=u'文章状态')
